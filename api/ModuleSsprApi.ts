...
export class ModuleSsprApi {
     ...
     */
    public ssprValidateTokenV1(ssprValidateTokenV1Request: models.SsprValidateTokenV1Request, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body?: any;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/1/module/sspr/validateToken';
        ...
        requestOptions.data = JSON.stringify(ssprValidateTokenV1Request);
        if (headerParams['Content-Type']) {
            requestOptions.contentType = headerParams['Content-Type'];
        }
