...
export class ObjectEzsigndocumentApi {
    ...
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/1/object/ezsigndocument/{pkiEzsigndocumentID}/getFormData'.replace('{' + 'pkiEzsigndocumentID' + '}', encodeURIComponent(String(pkiEzsigndocumentID)));

        let queryParameters: any = {};
        let headerParams: any = {};
        // verify required parameter 'pkiEzsigndocumentID' is not null or undefined
        if (pkiEzsigndocumentID === null || pkiEzsigndocumentID === undefined) {
            throw new Error('Required parameter pkiEzsigndocumentID was null or undefined when calling ezsigndocumentGetFormDataV1.');
        }
    ...
    { response: JQueryXHR; body: models.EzsigndocumentGetWordsPositionsV1Response;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/1/object/ezsigndocument/{pkiEzsigndocumentID}/getWordsPositions'.replace('{' + 'pkiEzsigndocumentID' + '}', encodeURIComponent(String(pkiEzsigndocumentID)));

        let queryParameters: any = {};
        let headerParams: any = {};
        // verify required parameter 'pkiEzsigndocumentID' is not null or undefined
        if (pkiEzsigndocumentID === null || pkiEzsigndocumentID === undefined) {
            throw new Error('Required parameter pkiEzsigndocumentID was null or undefined when calling ezsigndocumentGetWordsPositionsV1.');
        }

        // verify required parameter 'ezsigndocumentGetWordsPositionsV1Request' is not null or undefined
        if (ezsigndocumentGetWordsPositionsV1Request === null || ezsigndocumentGetWordsPositionsV1Request === undefined) {
            throw new Error('Required parameter ezsigndocumentGetWordsPositionsV1Request was null or undefined when calling ezsigndocumentGetWordsPositionsV1.');
        }
        ...
        requestOptions.data = JSON.stringify(ezsigndocumentGetWordsPositionsV1Request);
        if (headerParams['Content-Type']) {
            requestOptions.contentType = headerParams['Content-Type'];
        }
        ...
        >();
        $.ajax(requestOptions).then(
            (data: models.EzsigndocumentGetWordsPositionsV1Response, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve({response: jqXHR, body: data}),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject({response: xhr, errorThrown: errorThrown})
        );
