...
export class ObjectFranchiseofficeApi {
     ...
     */
    public franchiseofficeGetAutocompleteV1(sSelector: 'Active' | 'All', sQuery?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.CommonGetAutocompleteV1Response;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/1/object/franchiseoffice/getAutocomplete/{sSelector}'.replace('{' + 'sSelector' + '}', encodeURIComponent(String(sSelector)));
